...
- **Item 2 (race aggregation)** = project 5etools `ability`/`resist` → structured entity fields (like fivetools-field-fill / spell-class-join) → deterministic filter. GPU-free, in-session.
