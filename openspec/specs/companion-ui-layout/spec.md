# Spec: companion-ui-layout

## Purpose

Defines the physical folder layout for Blazor UI source within the single-host project and the expectations around static asset serving, orphaned folder removal, and post-reorganization build health.
