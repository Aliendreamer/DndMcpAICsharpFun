...
- [ ] 3.5 Re-ingest a book and confirm hybrid keyword ranking is corpus-consistent (operational — needs the running stack; existing `dnd_blocks` must be re-ingested once to pick up global weighting)
