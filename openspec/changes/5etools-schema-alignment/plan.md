...
- [ ] **Step 1: Update the spell fixture to 5etools format (test will fail)**
...
- [ ] **Step 3: Rewrite `SpellFields.schema.json`**
...
- [ ] **Step 1: Update the monster fixture to 5etools format**
...
- [ ] **Step 3: Rewrite `MonsterFields.schema.json`**
...
- [ ] **Step 1: Add Race and Subrace fixtures + InlineData**
...
- [ ] **Step 3: Rewrite `RaceFields.schema.json`**
...
- [ ] **Step 4: Rewrite `SubraceFields.schema.json`**
...
- [ ] **Step 1: Update Class fixture + add Subclass fixture and InlineData**
...
- [ ] **Step 3: Rewrite `ClassFields.schema.json`**
...
- [ ] **Step 4: Rewrite `SubclassFields.schema.json`**
...
- [ ] **Step 1: Add Background and Feat fixtures + InlineData**
...
- [ ] **Step 3: Rewrite `BackgroundFields.schema.json`**
...
- [ ] **Step 4: Rewrite `FeatFields.schema.json`**
...
- [ ] **Step 1: Add Weapon and Armor fixtures + InlineData**
...
- [ ] **Step 3: Rewrite `WeaponFields.schema.json`**
...
- [ ] **Step 4: Rewrite `ArmorFields.schema.json`**
...
- [ ] **Step 1: Add Item and MagicItem fixtures + InlineData**
...
- [ ] **Step 3: Rewrite `ItemFields.schema.json`**
...
- [ ] **Step 4: Rewrite `MagicItemFields.schema.json`**
...
- [ ] **Step 1: Add God fixture + InlineData**
...
- [ ] **Step 3: Rewrite `GodFields.schema.json`**
...
- [ ] **Step 1: Add four fixtures + InlineData**
...
- [ ] **Step 3: Rewrite `TrapFields.schema.json`**
...
- [ ] **Step 4: Rewrite `ConditionFields.schema.json`**
...
- [ ] **Step 5: Rewrite `DiseasePoisonFields.schema.json`**
...
- [ ] **Step 6: Rewrite `VehicleMountFields.schema.json`**
...
- [ ] **Step 1: Add Plane, Location, Faction fixtures + InlineData; update Lore and Rule fixtures**
...
- [ ] **Step 3: Rewrite `PlaneFields.schema.json`**
...
- [ ] **Step 4: Rewrite `LocationFields.schema.json`**
...
- [ ] **Step 5: Rewrite `FactionFields.schema.json`**
...
- [ ] **Step 6: Rewrite `LoreFields.schema.json`**
...
- [ ] **Step 7: Rewrite `RuleFields.schema.json`**
...
- [ ] **Step 3: Rewrite `ExtractionPromptBuilder.cs`**
...
- [ ] **Step 2: Rewrite the 3 sample entities to 5etools format**
...
- [ ] **Step 3: Validate against schemas manually**
