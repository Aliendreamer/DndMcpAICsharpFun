...
- [ ] **Step 1.2: Run test — confirm build failure**
...
- [ ] **Step 1.3: Create `DndMcpAICompanion/Features/Campaign/CharacterSheet.cs`**
...
- [ ] **Step 1.4: Run tests — all 3 must pass**
...
- [ ] **Step 2.2: Run to confirm build failure**
...
- [ ] **Step 2.3: Create `DndMcpAICompanion/Features/Campaign/CampaignRepository.cs`**
...
- [ ] **Step 2.4: Run tests — all 5 must pass**
...
- [ ] **Step 3.2: Run to confirm build failure**
...
- [ ] **Step 3.3: Create `DndMcpAICompanion/Features/Campaign/HeroRepository.cs`**
...
- [ ] **Step 3.4: Run tests — all 6 must pass**
...
- [ ] **Step 3.5: Run full companion test suite — no regressions**
